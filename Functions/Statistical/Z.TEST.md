...
Z.TEST performs statistical analysis and calculations for data summarization and insights.

> [!f(x)] Z.TEST Syntax
>
> ```spreadsheets
> Z.TEST(input_value, [options])
> ```
>
> **Parameters:**
...
>
> ```spreadsheets
> Z.TEST(A1) → result // Basic calculation
> 
> Z.TEST(A1:A10) → range_result // Process entire range
> ```
...
*Use IF with Z.TEST for conditional logic and decision making:*
```spreadsheets
=IF(Z.TEST(A1:A10)>threshold_value,"Condition Met","Condition Not Met")
```
This formula applies Z.TEST to a range and compares the result to a threshold, returning different text based on the condition

**[[SUM]]** - Aggregate values for total calculations

*Use SUM with Z.TEST for aggregate calculations across multiple results:*
```spreadsheets
=SUM(Z.TEST(A1:A5),Z.TEST(B1:B5),Z.TEST(C1:C5))
```
This formula calculates Z.TEST for multiple ranges and sums the results together

**[[AVERAGE]]** - Calculate arithmetic mean for central tendency analysis

*Use AVERAGE with Z.TEST for enhanced analytical workflows:*
```spreadsheets
=AVERAGE(Z.TEST(A1:A10))
```
This formula combines AVERAGE and Z.TEST for comprehensive data analysis
