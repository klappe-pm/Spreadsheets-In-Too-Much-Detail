...
KURT performs statistical analysis and calculations for data summarization and insights.

> [!f(x)] KURT Syntax
>
> ```spreadsheets
> KURT(input_value, [options])
> ```
>
> **Parameters:**
...
>
> ```spreadsheets
> KURT(A1) → result // Basic calculation
> 
> KURT(A1:A10) → range_result // Process entire range
> ```
...
*Use IF with KURT for conditional logic and decision making:*
```spreadsheets
=IF(KURT(A1:A10)>threshold_value,"Condition Met","Condition Not Met")
```
This formula applies KURT to a range and compares the result to a threshold, returning different text based on the condition

**[[SUM]]** - Aggregate values for total calculations

*Use SUM with KURT for aggregate calculations across multiple results:*
```spreadsheets
=SUM(KURT(A1:A5),KURT(B1:B5),KURT(C1:C5))
```
This formula calculates KURT for multiple ranges and sums the results together

**[[AVERAGE]]** - Calculate arithmetic mean for central tendency analysis

*Use AVERAGE with KURT for enhanced analytical workflows:*
```spreadsheets
=AVERAGE(KURT(A1:A10))
```
This formula combines AVERAGE and KURT for comprehensive data analysis
