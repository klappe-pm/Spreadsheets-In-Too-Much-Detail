...
VAR.P performs statistical analysis and calculations for data summarization and insights.

> [!f(x)] VAR.P Syntax
>
> ```spreadsheets
> VAR.P(input_value, [options])
> ```
>
> **Parameters:**
...
>
> ```spreadsheets
> VAR.P(A1) → result // Basic calculation
> 
> VAR.P(A1:A10) → range_result // Process entire range
> ```
...
*Use IF with VAR.P for conditional logic and decision making:*
```spreadsheets
=IF(VAR.P(A1:A10)>threshold_value,"Condition Met","Condition Not Met")
```
This formula applies VAR.P to a range and compares the result to a threshold, returning different text based on the condition

**[[SUM]]** - Aggregate values for total calculations

*Use SUM with VAR.P for aggregate calculations across multiple results:*
```spreadsheets
=SUM(VAR.P(A1:A5),VAR.P(B1:B5),VAR.P(C1:C5))
```
This formula calculates VAR.P for multiple ranges and sums the results together

**[[AVERAGE]]** - Calculate arithmetic mean for central tendency analysis

*Use AVERAGE with VAR.P for enhanced analytical workflows:*
```spreadsheets
=AVERAGE(VAR.P(A1:A10))
```
This formula combines AVERAGE and VAR.P for comprehensive data analysis
