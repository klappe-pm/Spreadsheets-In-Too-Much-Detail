...
## WEIBULL.DIST Description

WEIBULL.DIST performs statistical analysis and calculations for data summarization and insights.

> [!f(x)] WEIBULL.DIST Syntax
>
> ```spreadsheets
> WEIBULL.DIST(input_value, [options])
> ```
>
> **Parameters:**
...
> [!f(x)] WEIBULL.DIST Examples
>
> ```spreadsheets
> WEIBULL.DIST(A1) → result // Basic calculation
> 
> WEIBULL.DIST(A1:A10) → range_result // Process entire range
> ```
...
*Use IF with WEIBULL.DIST for conditional logic and decision making:*
```spreadsheets
=IF(WEIBULL.DIST(A1:A10)>threshold_value,"Condition Met","Condition Not Met")
```
This formula applies WEIBULL.DIST to a range and compares the result to a threshold, returning different text based on the condition

**[[SUM]]** - Aggregate values for total calculations

*Use SUM with WEIBULL.DIST for aggregate calculations across multiple results:*
```spreadsheets
=SUM(WEIBULL.DIST(A1:A5),WEIBULL.DIST(B1:B5),WEIBULL.DIST(C1:C5))
```
This formula calculates WEIBULL.DIST for multiple ranges and sums the results together

**[[AVERAGE]]** - Calculate arithmetic mean for central tendency analysis

*Use AVERAGE with WEIBULL.DIST for enhanced analytical workflows:*
```spreadsheets
=AVERAGE(WEIBULL.DIST(A1:A10))
```
This formula combines AVERAGE and WEIBULL.DIST for comprehensive data analysis
